...
const EVENT_QUIZ_STATUS_CHANGE        = 'QUIZ_STATUS_CHANGE';
...
export function registerQuizStatusChange(socket, reduce, getData) {
    socket.on(EVENT_QUIZ_STATUS_CHANGE, data => {
